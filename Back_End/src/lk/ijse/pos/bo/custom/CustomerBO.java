...
public interface CustomerBO extends SuperBO {
    ...
    boolean saveCustomer(CustomerDTO cusDto) throws SQLException, ClassNotFoundException;

    boolean save(CustomerDTO cusDto) throws SQLException, ClassNotFoundException;
