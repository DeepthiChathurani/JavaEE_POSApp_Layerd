...
ItemDAO itemDAO= (ItemDAO) DAOFactory.getDaoFactory().getDo(DAOFactory.DoType.Item);
    ...
    public boolean saveItem(ItemDTO dto) throws SQLException, ClassNotFoundException {
        try (Connection connection = ConnectionPoolManager.getInstance().getDataSource().getConnection()) {
            ...
            return itemDAO.save(connection,new Item(dto.getCode(), dto.getName(), (int) dto.getQty(), dto.getPrice()));
        }
    }
    @Override
    ...
    public boolean updateItem(ItemDTO itemDTO) throws SQLException, ClassNotFoundException {
        try (Connection connection = ConnectionPoolManager.getInstance().getDataSource().getConnection()) {
            ...
            return itemDAO.update(connection,new Item(itemDTO.getCode(), itemDTO.getName(), (int) itemDTO.getQty(), itemDTO.getPrice()));
        }
    }
    @Override
    ...
    public ItemDTO searchItem(String id) throws SQLException, ClassNotFoundException {
        try (Connection connection = ConnectionPoolManager.getInstance().getDataSource().getConnection()) {
            ...
            return new ItemDTO(dto.getCode(), dto.getName(), (int) dto.getQty(), dto.getPrice());
        }
    }
